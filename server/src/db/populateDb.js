    ...
    try {
        ...
        await pool.query(`
            INSERT INTO hackathonList (userId, title, summary, startingDate, deadline, type, location, themeId, details, resultsPublished, attachedFile, image, createdAt) VALUES
                ...
                (1, 'HACK A BOSS', 'Un hackathon de Web Development en A Coruña reunirá a desarrolladores, diseñadores y entusiastas de la tecnología para crear proyectos innovadores en un tiempo limitado. Será un evento colaborativo donde los participantes resolverán desafíos, aprenderán nuevas habilidades y conectarán con expertos del sector en un ambiente dinámico y creativo.', '2024-05-01 09:00:00', '2024-05-10 18:00:00', 'presencial', 'A coruña', 2, 'Detalles del evento de blockchain', TRUE, NULL, 'hackathon2.jpg', "${now}"),
